...
public class Paper : MonoBehaviour
{
    ...
    public static Vector3 cursorInitialPosition;
    public static Vector3 cursorDeltaPosition;
...
public class FoldPaper : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Paper.isDragging)
        {
            ...
            Debug.Log(direction);
            Paper.usingPaper.gameObject.transform.RotateAround(pos2, pos2 - pos1, value);
        }
    }
>>>>>>> Stashed changes
}